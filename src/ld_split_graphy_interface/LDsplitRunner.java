...
public class LDsplitRunner extends JFrame
{
  ...
  private JLabel IterationLabel = new JLabel("Rhomap -its:");
...
//    }
  ...
  public LDsplitRunner()
  {
      ...
      new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        ...
        LDsplitRunner.this.SiteFiletxtfiled.setText(str);
      }
    });
      ...
      new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        ...
        String str = filedialog.getDirectory() + filedialog.getFile();
        System.out.println(str);
        LDsplitRunner.this.LocsFiletxtfiled.setText(str);
      }
    });
      ...
      new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        if (LDsplitRunner.this.LkCalButton.isSelected()) {
          LDsplitRunner.this.LkFiletxtfiled.setEditable(false);
          LDsplitRunner.this.LkFiletxtfiled.setText("");
          LDsplitRunner.this.LkFileButton.setEnabled(false);
          ConfigureContainer.SetLkCalchoosed(true);
        } else {
          LDsplitRunner.this.LkFiletxtfiled.setEditable(true);
          LDsplitRunner.this.LkFileButton.setEnabled(true);
      ...
      new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        ...
        String str = filedialog.getDirectory() + filedialog.getFile();
        System.out.println(str);
        LDsplitRunner.this.LkFiletxtfiled.setText(str);
      }
    });
    this.panelParameter.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Parameter Setting"));

    this.Iterationtxtfiled.setColumns(5);
    this.panelParameter.add(this.IterationLabel);
    this.panelParameter.add(this.Iterationtxtfiled);

    this.RhomapSamptxtfiled.setColumns(5);
    this.panelParameter.add(this.RhomapSampLabel);
    this.panelParameter.add(this.RhomapSamptxtfiled);

    this.RhomapBurntxtfiled.setColumns(5);
    this.panelParameter.add(this.RhomapBurnLabel);
    this.panelParameter.add(this.RhomapBurntxtfiled);
      ...
      new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        ConfigureContainer.SetLocsFile(LDsplitRunner.this.LocsFiletxtfiled.getText());
        ConfigureContainer.SetSitesFile(LDsplitRunner.this.SiteFiletxtfiled.getText());
        ConfigureContainer.SetLkFile(LDsplitRunner.this.LkFiletxtfiled.getText());
        ConfigureContainer.SetIterationTime(Integer.valueOf(Integer.parseInt(LDsplitRunner.this.Iterationtxtfiled.getText())));
        ConfigureContainer.SetRhomap_Samp(Integer.valueOf(Integer.parseInt(LDsplitRunner.this.RhomapSamptxtfiled.getText())));
        ConfigureContainer.SetRhomap_Burn(Integer.valueOf(Integer.parseInt(LDsplitRunner.this.RhomapBurntxtfiled.getText())));
        ConfigureContainer.SetRhomap_bpen(Float.parseFloat(LDsplitRunner.this.RandomSampletxtfiled.getText()));
        ConfigureContainer.SetRhomap_hpen(Float.parseFloat(LDsplitRunner.this.MAFtxtfiled.getText()));

        LDsplitRunner.this.initConfigure();

        LDsplitRunner.this.caller = new LDsplitRunner.LDsplitCaller();

        LDsplitRunner.this.startJButton.setEnabled(false);
        LDsplitRunner.this.cancelJButton.setEnabled(true);
        LDsplitRunner.this.SiteFileButton.setEnabled(false);
        LDsplitRunner.this.LocsFileButton.setEnabled(false);
        LDsplitRunner.this.LkFileButton.setEnabled(false);
        LDsplitRunner.this.caller.execute();
      }
    });
      ...
      new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        ...
        if (res == 0) {
          ...
          LDsplitRunner.this.caller.cancel();
          LDsplitRunner.this.caller = null;
        }
      }
    });
    addWindowListener(new WindowAdapter()
    {
      public void windowClosing(WindowEvent e) {
        LDsplitRunner.this.LDsplitFrameClose = true;
  ...
  class LDsplitCaller extends SwingWorker<Integer, Integer>
  {
      ...
      throws Exception
    {
      ...
      LDsplitRunner.this.hotspotWindow_Run = new HotspotWindow();
      if (!LDsplitRunner.this.hotspotWindow_Run.loadSnp(LDsplitRunner.sitesFile, LDsplitRunner.locsFile)) {
        cancel();
        return Integer.valueOf(-1);
      }

      if (!LDsplitRunner.this.hotspotWindow_Run.test_snp()) {
        ParameterChecking.ErrorInforming("Input sequence number should be more than 20 and less than 192");
        cancel();
        return Integer.valueOf(-1);
      }

      if ((this.stopped) || (LDsplitRunner.this.LDsplitFrameClose)) {
        return Integer.valueOf(-1);
      }

      LDsplitRunner.this.hotspotWindow_Run.WholeRhoSnp(ConfigureContainer.GetSitesFile(), ConfigureContainer.GetLocsFile(), ConfigureContainer.GetLkFile(), 0);
    ...
    protected void done()
    {
      LDsplitRunner.this.startJButton.setEnabled(true);
      LDsplitRunner.this.cancelJButton.setEnabled(false);
      ...
      if (n == 0) {
        ...
        if (retVal == 0) {
          ...
          try
          {
            ...
            output.writeObject(LDsplitRunner.this.hotspotWindow_Run);
            if (output != null)
              output.close();
            else
      ...
      LDsplitRunner.this.hotspotWindow_Run = null;
    }
    ...
    public void cancel()
    {
      ...
      LDsplitRunner.this.startJButton.setEnabled(true);
      LDsplitRunner.this.cancelJButton.setEnabled(false);
      LDsplitRunner.this.SiteFileButton.setEnabled(true);
      LDsplitRunner.this.LocsFileButton.setEnabled(true);
      LDsplitRunner.this.LkFileButton.setEnabled(true);
      LDsplitRunner.this.hotspotWindow_Run = null;
    }
  }
